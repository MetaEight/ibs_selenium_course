...
public class NewBusinessTripPageSteps {
    ...
    @Step("Страница создания командировки: выбрать значение для поля Подразделение")
    ...
    @Step("Страница создания командировки: выбрать значение для поля Организация")
    ...
    @Step("Страница создания командировки: выбрать задачу")
    public NewBusinessTripPageSteps selectTask() {
        newBusinessTripPage.selectTask();
        return new NewBusinessTripPageSteps();
    }

    @Step("Страница создания командировки: выбрать значение для поля Город прибытия")
    ...
    @Step("Страница создания командировки: выбрать значение для полей Дата отправления и Дата возвращения")
    ...
    @Step("Страница создания командировки: проверить выбранные значения")
    ...
    @Step("Страница создания командировки: нажать на кнопку 'Сохранить и выйти'")
    public NewBusinessTripPageSteps saveAndClose() {
        newBusinessTripPage.clickBtnSaveAndClose();
        return new NewBusinessTripPageSteps();
    }

    @Step("Страница создания командировки: проверить текст ошибки")
